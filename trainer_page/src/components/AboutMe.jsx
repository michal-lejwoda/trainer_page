function AboutMe() {
    return (
        <div className="px-4">
            <div className="about_me--title my-8">
                <strong>
            ...
            <div className="about_me__gallery__container">
                <img className="rounded-2xl my-10" src="/Wojciech.jpg" alt=""/>
                <img className="rounded-2xl my-10" src="/Bartosz.jpg" alt=""/>
                <img className="rounded-2xl my-10" src="/Ewa_gnaslogo.png" alt=""/>
                <img className="rounded-2xl my-10" src="/Tomasz2.jpg" alt=""/>
                <img className="rounded-2xl my-10" src="/Wojciech.jpg" alt=""/>
                <img className="rounded-2xl my-10" src="/Bartosz.jpg" alt=""/>
            </div>
        </div>
