...
def hour_range(start_hour: datetime.time, end_hour: datetime.time, trainer_id: int) -> List[WorkHourCreate]:
    list_of_elements = []
    ...
    while end_of_start_hour < end_hour:
        ...
        list_of_elements.append(
            WorkHourCreate(start_time=start_hour, end_time=end_of_start_hour, is_active=True, trainer_id=trainer_id))
